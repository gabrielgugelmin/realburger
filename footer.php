...
?>
		...
		<footer class="Footer">
			<a href="mailto:contato@realburger.com.br">contato@realburger.com.br</a>
			...
			<a href="https://crowd.br.com/" target="_blank" class="Footer__crowd">
				<img src="assets/img/logo-crowd.png" alt="crowd">
			</a>
		</footer>
	</div> <!-- PageWrapper -->
	<?php wp_footer(); ?>
